    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('journal_visibility', models.CharField(choices=[('x', 'Private'), ('f', 'Followers'), ('p', 'Public')], default='f', max_length=1, verbose_name='journal visibility')),
                ('default_visibility', models.CharField(choices=[('x', 'Private'), ('f', 'Followers'), ('p', 'Public')], default='x', max_length=1, verbose_name='default entry visibility')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visibility', models.CharField(choices=[('x', 'Private'), ('f', 'Followers'), ('p', 'Public')], default='x', max_length=1)),
